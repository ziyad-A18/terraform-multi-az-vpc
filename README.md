...
This project was built as a hands-on complement to the **HashiCorp Certified: Terraform Associate** certification, applying every core exam concept (state management, workspaces, modules, variables, provisioning, security) to a real, working system rather than isolated exercises.
